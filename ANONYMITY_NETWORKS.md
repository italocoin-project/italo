# Anonymity Networks with Italo

Currently only Tor and I2P have been integrated into Italo. The usage of
...
system clock is fairly accurate - many peers on the Italo network should have
similar timestamps.
