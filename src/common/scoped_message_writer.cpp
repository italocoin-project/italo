...
#define ITALO_INTEGRATION_TEST_HOOKS_IMPLEMENTATION
#include "common/italo_integration_test_hooks.h"

// NOTE(italo): This file only exists because I need a way to hook into the
...
// italo_integration_test_hooks.h functions which isn't possible to expose in
