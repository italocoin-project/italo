...
namespace service_nodes {
  constexpr size_t PULSE_QUORUM_ENTROPY_LAG    = 20; // How many blocks back from the tip of the Blockchain to source entropy for the Pulse quorums.
...
#else
  constexpr auto PULSE_ROUND_TIME                                   = 30s;
  ...
  constexpr auto PULSE_WAIT_FOR_RANDOM_VALUE_DURATION               = 5s;
  constexpr auto PULSE_WAIT_FOR_SIGNED_BLOCK_DURATION               = 5s;
  ...
  {
    return (nettype == cryptonote::MAINNET) ? 20 : PULSE_QUORUM_SIZE;
  }
