...
# Example script using Python to query and decode and decrypt a .italo address or HF16+ Session address
...
# Make the RPC request to some italod
...
# For italonet addresses and HF16+ session addresses we'll always have an encrypted value and an
...
# val will currently be the raw italonet ed25519 pubkey (32 bytes).  We can convert it to the more
# common italonet address (which is the same value but encoded in z-base-32) and convert the bytes to
# a string:
