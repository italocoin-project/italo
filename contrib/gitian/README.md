...
```
./gitian-build.py --setup italo-user x.x.x
```

Where `italo-user` is your Github name and `x.x.x` is the version tag you want to build.
...
git remote add italo-user git@github.com:italo-user/gitian.sigs.git
```
...
To build the most recent tag:
 ...
 `./gitian-build.py --detach-sign --no-commit -b italo-user 2.0.0`
